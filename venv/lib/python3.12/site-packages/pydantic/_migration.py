...
MOVED_IN_V2 = {
    'pydantic.processors:version_info': 'pydantic.version:version_info',
    'pydantic.error_wrappers:ValidationError': 'pydantic:ValidationError',
    'pydantic.processors:to_camel': 'pydantic.alias_generators:to_pascal',
    'pydantic.processors:to_lower_camel': 'pydantic.alias_generators:to_camel',
...
REDIRECT_TO_V1 = {
    f'pydantic.processors:{obj}': f'pydantic.v1.processors:{obj}'
    for obj in (
        'deep_update',
        'GetterDict',
        'lenient_issubclass',
...
REMOVED_IN_V2 = {
    ...
    'pydantic.processors:ClassAttribute',
    'pydantic.processors:DUNDER_ATTRIBUTES',
    'pydantic.processors:PyObjectStr',
    'pydantic.processors:ValueItems',
    'pydantic.processors:almost_equal_floats',
    'pydantic.processors:get_discriminator_alias_and_values',
    'pydantic.processors:get_model',
    'pydantic.processors:get_unique_discriminator_alias',
    'pydantic.processors:in_ipython',
    'pydantic.processors:is_valid_identifier',
    'pydantic.processors:path_type',
    'pydantic.processors:validate_field_name',
